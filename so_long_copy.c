...
/*   Updated: 2026/05/21 15:33:04 by plepercq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_hook(int keysym, void *g)
{
	printf("KEY = %i\n", keysym);
...
int	main(int argc, char **argv)
{
	...
	mlx_hook(game.mlx_win, 17, 0L, game_clear, NULL);
	mlx_loop(game.mlx);
	sl_game_exit(&game, NULL);
	return (0);
}
